    ...
    <div class="row">
      <div class="col-lg-4 p-2">
        ...
        ?>
              ...
              <form class="text-left pt-4" action="Acarrito.php" method="POST">
                <!--Formulario-->
                <h4><strong><i class="fas fa-user"></i> Vendedor</strong></h4>
                ...
                <h4><strong><i class="fas fa-male"></i> Cliente</strong></h4>
                ...
                <a href="Acarrito.php"><button class="btn btn-success btn-block " type="submit">
      ...
      <div class="col-lg-8 p-5">
        ...
        <div class="row">
          ...
          ?>
              <div class="col text-right">
                <strong><label for=""><strong>Num. de Venta: </strong> <?php echo $x = $row['ID'] + 1; ?></label></strong>
              </div>
          <?php }
          } ?>
        </div>
        <div class="table-responsive">
          <table class="table product-table mb-0">
            <thead class=" encabezado lighten-5">
              <tr>
                <th></th>
        ...
        <div class="row">
          <div class="col pt-4 text-center">
            <form action="./controllers/model.php" method="POST">
              ...
              <input type="hidden" value="<?php echo $carrito->get_id_producto ?>" name="Id_producto">
              <input type="hidden" value="<?php echo $carrito->get_cantidad; ?>" name="Cantidad">
              <button type="submit" class="btn btn-danger"><span><i class="fa fa-ban" aria-hidden="true"></i></span>
                Cancelar</button></a>
            </form>
            <a onclick="if(!confirm('Esta apunto de confirmar la venta ¿Esta seguro?')){return false;}" target="_blank" href="./FPDF/index.php" class="btn btn-success"><span><i class="fa fa-check" aria-hidden="true"></i></span>
              Generar</a>
          </div>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="./controllers/model.php" method="POST">
            ...
            <button class="btn btn-outline-success waves-effect waves-light"><a type="submit"><strong><i class="fas fa-check"></i>Actualizar</strong>

              </a></button>
            <a type="button" class="btn btn-outline-danger waves-effect" data-dismiss="modal"><strong><i class="fa fa-ban"></i>Cancelar</strong></a>
          </form>
        </div>
      </div>
    </div>
