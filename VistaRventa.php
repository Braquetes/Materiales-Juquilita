...
<body class="body1">
  ...
  <!--Navbar-->
  <?php
  switch ($departamento = $_POST["departamento"]) {
    case 1:
      $departamentos = "Herramientas";
      break;
    case 2:
      $departamentos = "Electrónicos";
      break;
    case 3:
  ...
  <div class="container p-3">
    <div class="row">
      ...
      <div class="col-lg-9">
        <h1><strong>Historial del departamento <?php echo $departamentos ?></strong></h1>
      </div>
      <div class="col-lg-3">
        <div class="media white z-depth-1 rounded">
          ...
          <div class="media-body p-1">
            ...
            $muestraventas = mysqli_query($conexion, "SELECT SUM(Cantidad), ROUND(SUM(inventario_estadistica.Precio*Cantidad),2) as Total, Fecha from inventario_estadistica inner join productos on productos.tipo='".$departamento."' WHERE Id_producto = productos.id and Fecha >= '".$fecha1."' and Fecha <= '".$fecha2."' GROUP by Fecha");
            $TotalFinal = 0;
      ...
      <div class="col-lg-12">
        <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            $muestraventas = mysqli_query($conexion, "SELECT * FROM inventario_estadistica inner join productos on inventario_estadistica.Id_producto = productos.id  where Fecha >= '" . $fecha1 . "' and Fecha <= '" . $fecha2 . "' AND productos.tipo = ". $departamento);
            if ($muestraventas->num_rows > 0) {
              while ($row = mysqli_fetch_array($muestraventas)) {
            ?>
                <tr class="tr">
