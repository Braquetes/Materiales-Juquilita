...
<body class="body">
  ...
  <div class="container my-2 px-0 ">
    <section class=" my-md-5 text-center">
      <h3 class="  text-center "><strong>Actualización de Producto</strong></h3>
          ...
          <div class="col-md-4 mx-auto">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <h5 class="Texto1">Productos Existentes <span required class="badge badge-secondary"><?php echo $cantidad ?></span></h5>
                <div class="md-form">
                ...
                <button class="btn boton btn-success" type="submit" value="Actualizar" name="Valor"><i class="fas fa-check"></i> Actualizar</button>
