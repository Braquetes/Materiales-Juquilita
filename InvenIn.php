...
<style>
  ...
  .thead {
    color: white;
    background-color: RGB(130, 3, 198);
    font-weight: bold;
    text-align: center;
  }
...
<body class="body1">
  ...
  ?>
    ...
    <div class="container text-left pt-4 ">
      <div class="col-lg-12">
        <h1><strong>Inventario de Herramientas</strong></h1>
      </div>
    </div>
    <!-- <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <table id="example" class="table table-bordered " cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              ?>
                  <tr class="fila">
                    <td class="nombre"><?php echo $producto->get_nombre(); ?></td>
                    <td>$ <?php echo $producto->get_precio(); ?></td>
                    <td><?php echo $producto->get_cantidad_existente(); ?></td>
                    <td><?php echo $producto->get_tamaño(); ?></td>
                    <td class="botones">
                      <?php
                      if ($_SESSION["Puesto"] == "1" or $_SESSION["Puesto"] == "3") {
                      ?>
                        <form action="Palta.php" method="POST">
                          <button class="btn opc btn-success" type="submit"><i class="fas fa-check"></i> <strong> Actualizar</strong>
                            <span></span> </button></a>
                      ...
                      <form action="PInven.php" method="POST">
                        <button class="btn opc btn-primary" type="submit"><i class="fas fa-history"></i> <strong> Historial</strong>
                          <span></span> </button></a>
                        <!--  <button class="btn Boton4" type="submit">Historial
                        <span><i class="far fa-clock"></i></span> </button></a> -->
                        <input type="hidden" name="ID" value="<?php echo $producto->get_id(); ?>">
                      </form>
                      <?php if ($_SESSION["Puesto"] == "1" or $_SESSION["Puesto"] == "3") { ?>
                        <form action="Eliminar.php" method="POST">
                          <button class="btn opc btn-danger" type="submit"><span><i class="fas fa-trash"> </i><strong> Eliminar</strong>
                              <input type="hidden" name="id" value="<?php echo $producto->get_id(); ?>">
...
?>
  ...
  <div class="container text-left pt-4 ">
    <div class="col-lg-12">
      <h1><strong>Inventario de Electrónicos</strong></h1>
    </div>
  </div>
  <!-- <div class="container">
    <div class="row">
...
?>
  ...
  <div class="container text-left pt-4 ">
    <div class="col-lg-12">
      <h1><strong>Inventario de Limpieza</strong></h1>
    </div>
  </div>
  <br>
  <!--Inicio-->
...
?>
  ...
  <div class="container text-left pt-4 ">
    <div class="col-lg-12">
      <h1><strong>Inventario de Equipos</strong></h1>
    </div>
  </div>
  <!-- <div class="container">
    <div class="row">
...
?>
  ...
  <div class="container text-left pt-4 ">
    <div class="col-lg-12">
      <h1><strong>Inventario de Redes</strong></h1>
    </div>
  </div>
  <!--  <div class="container">
    <div class="row">
...
?>
  ...
  <div class="container text-left pt-4 ">
    <div class="col-lg-12">
      <h1><strong>Inventario de Software</strong></h1>
    </div>
  </div>
  <!-- <div class="container">
    <div class="row">
