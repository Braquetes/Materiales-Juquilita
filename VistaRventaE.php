...
<body class="body1">
  ...
  <div class="container p-3">
    <div class="row">
      ...
      <div class="col-lg-9">
        <h1><strong>Historial de Productos Especificos</strong></h1>
      </div>
    </div>
  </div>
  <br>
          ...
          <tbody>
            ...
            ?>
                <?php if ($rows["Id_departamento"] == "1") { ?>
                  ...
                  $muestraventas = mysqli_query($conexion, "SELECT * FROM inventario_estadistica inner join productos on inventario_estadistica.Id_producto = productos.id  where Fecha >= '" . $fecha1 . "' and Fecha <= '" . $fecha2 . "' AND productos.tipo =" . $tip);
